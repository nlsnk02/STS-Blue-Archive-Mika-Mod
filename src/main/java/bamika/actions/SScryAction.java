...
public class SScryAction extends AbstractGameAction {
    ...
    /*
    then 传入的第一个是御剑到的牌，第二个是选择了的牌
    then 触发在卡牌丢入弃牌堆以后
     */
    public SScryAction(int numCards, BiConsumer<ArrayList<AbstractCard>, ArrayList<AbstractCard>> then) {
